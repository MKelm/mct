    ...
    'scenes/events/windows/message.json',
    {
      ...
      "dynEventDescription" :
        ["You are a master of control, you can click on start and quit or ",
         "press F1 to get a FPS Counter. If you press F2 you can open the bugs survey ",
         "at every time, use it if you detect bugs. The general survey with F3 will ",
         "be available for alpha 1, have fun with this pre-alpha version."],
