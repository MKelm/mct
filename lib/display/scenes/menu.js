...
function displaySceneMenuAdd() {
  ...
  // test for event message window
  // this is an implementation for development purposes
  displayWindowAdd(
    'eventmessage',
    'scenes/events/windows/message.json',
    {
      "dynEventTitle" : "The great menu event",
      "dynEventDescription" :
        ["You are a master of the menu, you can click on start and quit or ",
         ...
         "bug. If you want to listen to music click on the play button in the lower ",
         "right corner."],
