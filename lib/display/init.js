...
$(document).ready(function() {
  baseUtilSetTimeout(displayInit, 0.00000001); // use timeout to detect fullscreen size correctly
  ...
  function displayInit() {
    ...
    var devMode = true;
    loader.onComplete = devMode ? displayScenePlanetAdd : displaySceneMenuAdd;
    loader.load();
  }
});
