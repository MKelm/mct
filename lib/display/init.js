...
baseValues.pixi = { renderer : null, stage : null, text : {}, currentScene : "", scenes : {} };
$.getJSON('txt/styles.json', function(data) {
  baseValues.pixi.text.styles = data;
});
$.getJSON('txt/lngs/en-US.json', function(data) {
  baseValues.pixi.text.lang = data;
});
...
$(document).ready(function() {
  ...
  function displayInit() {
    ...
    baseValues.pixi.stage = new PIXI.Stage(0x000000, true); // interactive
