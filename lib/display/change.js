...
$("html").keyup(function(e){
  if (e.which == 112){
    if (mct.status.pixi.fps[0] < 0) {
      ...
      mct.setTimeout(function(){ displayFpsCounter(); }, 1000, "fpsCounter");
    } else {
...
$("html").keyup(function(e){
  if (e.which == 113){
    ...
    // todo add http://mct.shrt.ws/surveys/... url
    displayChangeToggleSurvey('surveyBugs', 'http://mkelm.github.io');
  } else if (e.which == 114){
    // hotkey F3 to enable / disable survey layer for general questions
    // todo add http://mct.shrt.ws/surveys/... url
    displayChangeToggleSurvey('surveyGeneral', 'http://mkelm.github.io');
  }
});
