...
MCT.Game.prototype.start = function() {
  ...
  mct.sceneHandler.addScene('menu', this.elements.panels.menu);
  ...
  this.elements.space = new MCT.Space(1.0, 1.0);

  mct.sceneHandler.addScene('space', this.elements.space);

  mct.sceneHandler.addScene('planet', this.elements.planets.anuka);
