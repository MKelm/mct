...
MCT.AudioHandler = function(config) {
  try {
    ...
    this.meta.channels.amount = config.channels.amount;
    this.meta.channels.status = [];
    this.effects = data.effects;
    this.effects.active = config.effects.active;
    this.music = data.music;
    this.music.active = config.music.active;
    this.music.playOnStart = config.music.playOnStart;
    this.players = [];
