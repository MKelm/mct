...
MCT.DisplayObject.prototype.current() {
  if (container === null) {
    if (type === null) {
...
MCT.DisplayObject.prototype.createContainer() {
  this.container = new PIXI.DisplayObjectContainer();
  return this.container;
}

MCT.DisplayObject.prototype.create() {
  switch (this.type) {
    case 'button':
...
MCT.DisplayObject.prototype.setInteraction(sprite, options) {
...
MCT.DisplayObject.prototype.createButton(options) {
