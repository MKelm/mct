      ...
      if (locations[i][spn].parts.length > 0) {
        ...
        do {
          ...
          if (locations[i][spn].parts[j].displayObject instanceof MCT.DisplayObject) {
            ...
            if (locations[i].maxWidth < locations[i][spn].parts[j].width + (padding.left || 0) + (padding.right || 0)) {
              locations[i].maxWidth = locations[i][spn].parts[j].width + (padding.left || 0) + (padding.right || 0);
            }
