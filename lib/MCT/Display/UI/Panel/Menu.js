...
MCT.DisplayUIPanelMenu = function() {
  ...
  var partName = this.layout.addPart(partOptions);
  this.layout.addDisplayObjectToPart(
    partName, this.layout.displayObjects.add("menuGameTitle", 'text', { value: "Mass Control Tycoon", style: "gametitle1" })
  );
  ...
  this.layout.addDisplayObjectToPart(
    ...
    this.layout.displayObjects.add(
      "menuButtonStart", 'button', { image: "mct_menu_button", text: { value: "Start", style: "menubutton1" } }
    )
  );
  ...
  this.layout.addDisplayObjectToPart(
    partName,
    this.layout.displayObjects.add(
      "menuButtonQuit", 'button', { image: "mct_menu_button", text: { value: "Quit", style: "menubutton1" } }
    )
  );
}
