...
MCT.DisplayUIPanel = function(name, unitSize, position) {
  MCT.Element.call(this, name, "panel");
  ...
  this.grid = new MCT.Grid({ width: 1280 / (unitSize || 1), height: 1024 / (unitSize || 1) });
  ...
  this.layout = new MCT.DisplayUILayout(
    this.grid, { elementHandle: name+'panel', size: size, position: position }
  );
}
