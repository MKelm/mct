...
MCT.DisplayObjects.prototype.add = function(name, type, options) {
  if (type != "container") {
    ...
    /*if (typeof options.owner.center == "object") {
      console.log(1);
      options.owner.container.pivot.x = 0;
      options.owner.container.pivot.y = 0;
      options.owner.container.position.x = 0;
      options.owner.container.position.y = 0;
    }*/
    var object = new MCT.DisplayObject("container", null, options.owner.container);
