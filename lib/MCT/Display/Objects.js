...
MCT.DisplayObjects.prototype.loadTextStyleOptions = function(options) {
  if (typeof options.text == "object" && typeof options.text.style != "undefined") {
    if (typeof this.textStylesOptions[options.text.style] != "undefined") {
      options.text.style = this.textStylesOptions[options.text.style];
    }
  }
}
