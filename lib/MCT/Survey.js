...
MCT.Survey.prototype.toggle = function() {
  if (this.active === true) {
    ...
    var marginLeft = Number($("body").css("padding-left").replace("px",""));
    var x = marginLeft + Math.ceil(50 * mct.pixi.screen.ratio);
    $('body').append(
    ...
    $('body').append(
      ...
      + (y + Math.ceil(1 * mct.pixi.screen.ratio)) + 'px; left: ' + (x + Math.ceil(mct.pixi.screen.ratio)) +
