...
mct.getCommitHash = function(callback) {
  var fs = require('fs');
...
mct.getVersionHash = function(callback) {
...
mct.updateVersionHashes = function() {
  var hashes = './HASHES';
  var fs = require('fs');
  fs.readFile(hashes, { encoding : "utf8" }, function(err, data) {
    ...
    mct.getVersionHash(function(lastVersionHash){
      if (lastHashes === '' || lastHashes[0] != "V"+lastVersionHash) {
        mct.getCommitHash(function(lastCommitHash) {
